import { ChartBarIcon, ChartPieIcon, DocumentCheckIcon, Square2StackIcon, UsersIcon } from "@heroicons/react/16/solid";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-3">
          <ProjectsLink name="Virtual Reality" setSelectedProjects={setSelectedProject}>
            <div className="min-w-4 mx-2 border-pink-600 border rounded-full aspect-square bg-pink-700"></div>
          </ProjectsLink>

          <ProjectsLink name="Apple Vision" setSelectedProjects={setSelectedProject}>
            <div className="min-w-4 mx-2 border-indigo-600 border rounded-full aspect-square bg-indigo-700"></div>
          </ProjectsLink>

          <ProjectsLink name="Porsche" setSelectedProjects={setSelectedProject}>
            <div className="min-w-4 mx-2 border-cyan-600 border rounded-full aspect-square bg-cyan-700"></div>
          </ProjectsLink>

          <ProjectsLink name="Secret Project" setSelectedProjects={setSelectedProject}>
            <div className="min-w-4 mx-2 border-yellow-600 border rounded-full aspect-square bg-yellow-700"></div>
          </ProjectsLink>
        </div>
      </motion.nav>
      <AnimatePresence>
